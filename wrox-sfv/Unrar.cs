...
/*  Author: Daniel Stephenson
    Date: 27/03/05
    Filename: Unrar.cs
    Function: unrar (adapted code.. credit for some code used to Michael A. McCloskey (below)
*/
	...
	public class Unrar : IDisposable
	{
		...
		private void ProcessFileError(int result)
		{
			switch((RarError)result)
			{
				...
				case RarError.BadData:
					throw new IOException("WRoX SFV Aborted: \n\n File CRC Error");
